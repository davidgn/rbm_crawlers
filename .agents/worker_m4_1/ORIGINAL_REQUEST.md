# Worker Task Request — Milestone 4: Custom Standalone Spiders Group 3
...
5. Test and verify all modified files. Document changes and test results in `/opt/repos/rbm_crawlers/.agents/worker_m4_1/handoff.md`.
