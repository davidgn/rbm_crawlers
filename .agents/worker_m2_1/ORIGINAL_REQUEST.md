# Worker Task Request — Milestone 2: Custom Standalone Spiders Group 1
...
5. Test and verify all modified files. Document changes and test results in `/opt/repos/rbm_crawlers/.agents/worker_m2_1/handoff.md`.
