# Worker Task Request — Milestone 3: Custom Standalone Spiders Group 2
...
5. Test and verify all modified files. Document changes and test results in `/opt/repos/rbm_crawlers/.agents/worker_m3_1/handoff.md`.
