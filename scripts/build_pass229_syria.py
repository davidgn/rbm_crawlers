...
files_to_package = [
    'docs/00_READ_FIRST_CAPSULE_HISTORY_RBM_PASS228_TO_PASS229_SYRIA_2026-07-19.md',
    'docs/00_READ_FIRST_CONTINUITY_HANDOFF_RBM_POST_PASS229_SYRIA_2026-07-19.md',
    'docs/00_READ_FIRST_TECHNICAL_OBSERVATIONS_AND_DECISIONS_RBM_POST_PASS229_SYRIA_2026-07-19.md',
    'docs/00_READ_FIRST_RESUME_PROMPT_RBM_POST_PASS229_SYRIA_2026-07-19.md',
    'docs/ROW_COUNT_VALIDATION_RBM_POST_PASS229_SYRIA_2026-07-19.txt',
    'docs/CURRENT_STATE_SNAPSHOT_RBM_PASS229_SYRIA_2026-07-19.json',
    'docs/COMPLETE_CHAT_TRANSCRIPT_RBM_PASS228_TO_PASS229_SYRIA_2026-07-19.md',
    ...
    'scripts/sync_syria_pass229.py'
]

temp_dir = 'temp_pass229_flat'
...
shutil.copy('scripts/build_pass229_syria.py', temp_dir)
...
sums_filename = 'SHA256SUMS_RBM_POST_PASS229_SYRIA_2026-07-19.txt'
...
zip_filename = 'rbm_checkpoint_handoff_FLAT_ROOT_2026-07-19_post_pass229_syria_v1.zip'
