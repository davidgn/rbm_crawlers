...
| 8 | More Low-Cost Bookstore Spiders | Implement and upgrade bookstore-specific crawlers for Algeria (Livres & Lis) and North Macedonia (Matica Makedonska) using WooCommerce API, and Venezuela (Libronomia) using Shopify suggest API | none | COMPLETED |
