...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    public ProxyResponse(int i, int i4, PendingIntent pendingIntent, int i5, Bundle bundle, byte[] bArr) {
        this.zza = i;
    ...
    public static ProxyResponse createErrorProxyResponse(int i, PendingIntent pendingIntent, int i4, Map<String, String> map, byte[] bArr) {
    ...
    public ProxyResponse(int i, PendingIntent pendingIntent, int i4, Bundle bundle, byte[] bArr) {
