...
public final class zzqg {
    ...
    public static final zzqg zzS;
    public static final zzqg zzT;
    public static final zzqg zzU;
    public static final zzqg zzV;
    public static final zzqg zzW;
    public static final zzqg zzX;
    public static final zzqg zzY;
    private static final zzqg[] zzZ;
    public static final zzqg zza;
    private static final /* synthetic */ zzqg[] zzaa;
    public static final zzqg zzb;
    public static final zzqg zzc;
    public static final zzqg zzd;
    public static final zzqg zze;
    ...
    private zzqg(String str, int i, int i4, int i5, zzqv zzqvVar) {
        ...
        if (i5 == 1) {
            zzqv zzqvVar2 = zzqv.zza;
            zzqvVar.ordinal();
        }
    }

    public static zzqg[] values() {
        return (zzqg[]) zzaa.clone();
    }
