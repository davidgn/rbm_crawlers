...
final class zzcgp extends zzfzq {
    ...
    public final void zza() {
        ...
        handlerThread.start();
        zzfzn zzfznVar = new zzfzn(handlerThread.getLooper());
        this.zzg = zzfznVar;
        if (sensorManager.registerListener(this, defaultSensor, 0, zzfznVar)) {
            return;
        }
    ...
    public final void zzb() {
        ...
        this.zzg.post(new zzcgn(this));
        this.zzg = null;
    }

    public final void zzc(zzcgo zzcgoVar) {
        this.zzh = zzcgoVar;
    }
