...
public class AppMeasurementSdk {
    ...
    public interface EventInterceptor extends zzhe {
        ...
        @ShowFirstParty
        @KeepForSdk
        void interceptEvent(String str, String str2, Bundle bundle, long j5);
    }
    ...
    public Map<String, Object> getUserProperties(String str, String str2, boolean z4) {
        return this.zza.zzr(str, str2, z4);
    }
    ...
    @KeepForSdk
    public void logEventNoInterceptor(String str, String str2, Bundle bundle, long j5) {
    ...
    public void setMeasurementEnabled(boolean z4) {
        this.zza.zzL(Boolean.valueOf(z4));
    }
