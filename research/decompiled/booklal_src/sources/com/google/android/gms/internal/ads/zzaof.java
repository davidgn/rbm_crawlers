...
public final class zzaof {
    ...
    private static int zzA(int i, String str, String str2, int i4) {
        if (str.isEmpty() || i == -1) {
            return i;
        }
        if (str.equals(str2)) {
    ...
    public final zzaof zzh(boolean z4) {
        this.zzj = 1;
        return this;
    }

    public final zzaof zzi(boolean z4) {
        this.zzk = 1;
        return this;
    }

    public final zzaof zzj(boolean z4) {
        this.zzl = 1;
        return this;
    }
    ...
    public final zzaof zzl(String str) {
        this.zze = zzgrs.zza(str);
        return this;
    }
    ...
    public final zzaof zzs(float f5) {
        this.zzn = f5;
        return this;
    }

    public final zzaof zzt(int i) {
        this.zzm = i;
        return this;
    }
    ...
    public final zzaof zzy(boolean z4) {
        this.zzp = z4;
        return this;
    }
