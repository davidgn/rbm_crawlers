...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    public static class ProgressInfo {
        ...
        public ProgressInfo(long j5, long j6) {
    ...
    public ModuleInstallStatusUpdate(int i, int i4, Long l5, Long l6, int i5) {
        this.zaa = i;
        this.zab = i4;
        this.zac = l5;
        this.zad = l6;
        this.zae = i5;
        this.zaf = (l5 == null || l6 == null || l6.longValue() == 0) ? null : new ProgressInfo(l5.longValue(), l6.longValue());
    }
