...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    @Deprecated
    public MethodInvocation(int i, int i4, int i5, long j5, long j6, String str, String str2, int i6) {
        this(i, i4, i5, j5, j6, str, str2, i6, -1);
    }
    ...
    public MethodInvocation(int i, int i4, int i5, long j5, long j6, String str, String str2, int i6, int i7) {
        this.zaa = i;
        this.zab = i4;
        this.zac = i5;
        this.zad = j5;
