...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(a.i(i, "Overread allowed size end=", new StringBuilder(String.valueOf(i).length() + 26)), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            if (i < dataPosition || i > parcel.dataSize()) {
                throw new ParseException(com.google.android.gms.ads.internal.util.client.a.h(new StringBuilder(String.valueOf(dataPosition).length() + 32 + String.valueOf(i).length()), "Size read is invalid start=", dataPosition, " end=", i), parcel);
            }
            return i;
        }
    ...
    private static void zza(Parcel parcel, int i, int i4) {
        ...
        int length2 = String.valueOf(readSize).length();
        StringBuilder sb = new StringBuilder(String.valueOf(hexString).length() + length + 19 + length2 + 4 + 1);
        a.u(sb, "Expected size ", i4, " got ", readSize);
        throw new ParseException(a.q(sb, " (0x", hexString, ")"), parcel);
    }

    private static void zzb(Parcel parcel, int i, int i4, int i5) {
        if (i4 == i5) {
            return;
        }
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(hexString).length() + length + 19 + length2 + 4 + 1);
        a.u(sb, "Expected size ", i5, " got ", i4);
        throw new ParseException(a.q(sb, " (0x", hexString, ")"), parcel);
    }
}
