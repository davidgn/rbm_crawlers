...
public final class zzcy implements Executor {
    ...
    public zzcy(String str) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(1, 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactory("Google consent worker") { // from class: com.google.android.gms.internal.consent_sdk.zzcx
    ...
    public static /* synthetic */ Thread zza(zzcy zzcyVar, String str, Runnable runnable) {
        Thread thread = new Thread(runnable, i.a(zzcyVar.zza.getAndIncrement(), "Google consent worker #"));
