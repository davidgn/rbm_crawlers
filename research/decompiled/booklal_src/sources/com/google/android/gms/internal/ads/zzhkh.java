...
public final class zzhkh {
        ...
        if (zzb(eCParameterSpec, zza) || zzb(eCParameterSpec, zzb) || zzb(eCParameterSpec, zzc)) {
            if (bigInteger.signum() == 1) {
                if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                    ...
                    zzhkg zze2 = zze(ECPoint.POINT_INFINITY, zzc2);
                    zzhkg zze3 = zze(generator, zzc2);
    ...
    public static zzhkg zze(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return zzhkg.zzd;
        }
        BigInteger mod = new BigInteger(1, zzhmt.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zzhkg(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }

    public static zzhkg zzf(zzhkg zzhkgVar, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = zzhkgVar.zzb;
        if (bigInteger3.equals(BigInteger.ZERO)) {
            return zzhkg.zzd;
        }
        BigInteger bigInteger4 = zzhkgVar.zza;
        ...
        BigInteger bigInteger5 = zzhkgVar.zzc;
        ...
        return new zzhkg(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }

    public static zzhkg zzg(zzhkg zzhkgVar, zzhkg zzhkgVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzhkgVar.zza()) {
            return zzhkgVar2;
        }
        if (zzhkgVar2.zza()) {
        ...
        BigInteger bigInteger3 = zzhkgVar.zzc;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zzhkgVar2.zzc;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = zzhkgVar.zza.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzhkgVar2.zza.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzhkgVar.zzb.multiply(bigInteger4).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzhkgVar2.zzb.multiply(bigInteger3).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? zzhkg.zzd : zzf(zzhkgVar, bigInteger, bigInteger2);
        }
        ...
        return new zzhkg(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }
