...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(int i, int i4, PendingIntent pendingIntent, String str, Integer num) {
        this.zza = i;
        this.zzb = i4;
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            default:
                                return a.g(new StringBuilder(String.valueOf(i).length() + 20), "UNKNOWN_ERROR_CODE(", i, ")");
                        }
                }
            }
