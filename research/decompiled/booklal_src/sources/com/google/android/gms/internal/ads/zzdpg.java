...
public interface zzdpg {
    ...
    void zzc(View view, View view2, Map map, Map map2, boolean z4, ImageView.ScaleType scaleType);

    void zzd(String str);

    void zze(Bundle bundle);

    void zzf(View view, View view2, Map map, Map map2, boolean z4, ImageView.ScaleType scaleType, int i);
