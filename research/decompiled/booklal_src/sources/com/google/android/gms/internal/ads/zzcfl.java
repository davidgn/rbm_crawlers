...
final class zzcfl extends zzcfm implements ViewTreeObserver.OnScrollChangedListener {
    private final WeakReference zza;

    public zzcfl(View view, ViewTreeObserver.OnScrollChangedListener onScrollChangedListener) {
        super(view);
