...
public class ImmutableSortedSet<T> implements Iterable<T> {
    ...
    public boolean contains(T t2) {
        return this.map.containsKey(t2);
    }
    ...
    public T getPredecessorEntry(T t2) {
        return this.map.getPredecessorKey(t2);
    }
    ...
    public int indexOf(T t2) {
        return this.map.indexOf(t2);
    }

    public ImmutableSortedSet<T> insert(T t2) {
        return new ImmutableSortedSet<>(this.map.insert(t2, null));
    }
    ...
    public Iterator<T> iteratorFrom(T t2) {
        return new WrappedEntryIterator(this.map.iteratorFrom(t2));
    }

    public ImmutableSortedSet<T> remove(T t2) {
        ImmutableSortedMap<T, Void> remove = this.map.remove(t2);
    ...
    public Iterator<T> reverseIteratorFrom(T t2) {
        return new WrappedEntryIterator(this.map.reverseIteratorFrom(t2));
    }
