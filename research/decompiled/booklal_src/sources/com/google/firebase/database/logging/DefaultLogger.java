...
public class DefaultLogger implements Logger {
    ...
    public String buildLogMessage(Logger.Level level, String str, String str2, long j5) {
    ...
    @Override // com.google.firebase.database.logging.Logger
    public void onLogMessage(Logger.Level level, String str, String str2, long j5) {
        if (shouldLog(level, str)) {
            String buildLogMessage = buildLogMessage(level, str, str2, j5);
