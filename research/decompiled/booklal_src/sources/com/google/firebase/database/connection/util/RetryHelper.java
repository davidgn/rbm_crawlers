...
public class RetryHelper {
    ...
    public static class Builder {
        ...
        public Builder withMaxDelay(long j5) {
            this.retryMaxDelay = j5;
            return this;
        }

        public Builder withMinDelayAfterFailure(long j5) {
            this.minRetryDelayAfterFailure = j5;
            return this;
        }
    ...
    public void retry(final Runnable runnable) {
        ...
        if (!this.lastWasSuccess) {
            long j6 = this.currentRetryDelay;
            if (j6 == 0) {
                this.currentRetryDelay = this.minRetryDelayAfterFailure;
            } else {
                this.currentRetryDelay = Math.min((long) (j6 * this.retryExponent), this.maxRetryDelay);
            }
            double d2 = this.jitterFactor;
            long j7 = this.currentRetryDelay;
            j5 = (long) ((this.random.nextDouble() * d2 * j7) + ((1.0d - d2) * j7));
        }
        this.lastWasSuccess = false;
        this.logger.debug("Scheduling retry in %dms", Long.valueOf(j5));
        this.scheduledRetry = this.executorService.schedule(runnable2, j5, TimeUnit.MILLISECONDS);
    }
    ...
    private RetryHelper(ScheduledExecutorService scheduledExecutorService, LogWrapper logWrapper, long j5, long j6, double d2, double d5) {
        this.random = new Random();
        this.lastWasSuccess = true;
        this.executorService = scheduledExecutorService;
        this.logger = logWrapper;
        this.minRetryDelayAfterFailure = j5;
        this.maxRetryDelay = j6;
        this.retryExponent = d2;
