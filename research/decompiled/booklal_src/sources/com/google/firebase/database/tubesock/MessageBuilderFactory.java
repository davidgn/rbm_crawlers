...
class MessageBuilderFactory {
    ...
    public static class BinaryBuilder implements Builder {
        ...
        public WebSocketMessage toMessage() {
            ...
            int i = 0;
            for (int i4 = 0; i4 < this.pendingBytes.size(); i4++) {
                byte[] bArr2 = this.pendingBytes.get(i4);
    ...
    public static Builder builder(byte b5) {
        return b5 == 2 ? new BinaryBuilder() : new TextBuilder();
    }
}
