...
public final class FieldPath extends BasePath<FieldPath> {
        ...
        while (i < str.length()) {
            ...
            if (charAt == '\\') {
                ...
                if (z4) {
                    ...
                    if (sb2.isEmpty()) {
                        throw new IllegalArgumentException(a.l("Invalid field path (", str, "). Paths must not be empty, begin with '.', end with '.', or contain '..'"));
                    }
    ...
    @Override // com.google.firebase.firestore.model.BasePath
    public /* bridge */ /* synthetic */ FieldPath createPathWithSegments(List list) {
    ...
    public FieldPath createPathWithSegments2(List<String> list) {
