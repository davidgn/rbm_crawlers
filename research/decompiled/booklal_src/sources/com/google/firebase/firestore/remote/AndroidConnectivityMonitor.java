...
public final class AndroidConnectivityMonitor implements ConnectivityMonitor {
    ...
    private void configureNetworkMonitoring() {
        if (this.connectivityManager != null) {
            ...
            this.unregisterRunnable = new b(3, this, defaultNetworkCallback);
            return;
        }
        NetworkReceiver networkReceiver = new NetworkReceiver();
        this.context.registerReceiver(networkReceiver, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
        this.unregisterRunnable = new b(4, this, networkReceiver);
    }
        ...
        synchronized (this.callbacks) {
            try {
                for (Consumer<ConnectivityMonitor.NetworkStatus> consumer : this.callbacks) {
                    consumer.accept(z4 ? ConnectivityMonitor.NetworkStatus.REACHABLE : ConnectivityMonitor.NetworkStatus.UNREACHABLE);
                }
            } catch (Throwable th) {
                throw th;
            }
