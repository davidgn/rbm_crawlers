...
public class BundleMetadata implements BundleElement {
    ...
    public BundleMetadata(String str, int i, SnapshotVersion snapshotVersion, int i4, long j5) {
        this.bundleId = str;
    ...
    public int hashCode() {
        ...
        return this.createTime.hashCode() + (((((((this.bundleId.hashCode() * 31) + this.schemaVersion) * 31) + this.totalDocuments) * 31) + ((int) (j5 ^ (j5 >>> 32)))) * 31);
    }
}
