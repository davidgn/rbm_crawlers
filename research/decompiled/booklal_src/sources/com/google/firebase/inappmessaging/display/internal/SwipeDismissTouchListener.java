...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    private void animateTo(float f5, float f6, AnimatorListenerAdapter animatorListenerAdapter) {
        final float translationX = getTranslationX();
        final float f7 = f5 - translationX;
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.firebase.inappmessaging.display.internal.SwipeDismissTouchListener.2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                float animatedFraction = (valueAnimator.getAnimatedFraction() * f7) + translationX;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (actionMasked != 1) {
            ...
            if (Math.abs(rawX2) > this.mViewWidth / 2 && this.mSwiping) {
                z4 = rawX2 > 0.0f;
            } else if (this.mMinFlingVelocity > abs || abs > this.mMaxFlingVelocity || abs2 >= abs || i >= 0 || !this.mSwiping) {
                z4 = false;
                r4 = false;
            } else {
    ...
    public void startDismissAnimation(boolean z4) {
        animateTo(z4 ? this.mViewWidth : -this.mViewWidth, 0.0f, new AnimatorListenerAdapter() { // from class: com.google.firebase.inappmessaging.display.internal.SwipeDismissTouchListener.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
