...
public class InAppMessageLayoutConfig {
    ...
    public static class Builder {
        ...
        public Builder setMaxBodyHeightWeight(Float f5) {
            this.config.maxBodyHeightWeight = f5;
            return this;
        }

        public Builder setMaxBodyWidthWeight(Float f5) {
        ...
        public Builder setMaxImageHeightWeight(Float f5) {
            this.config.maxImageHeightWeight = f5;
            return this;
        }

        public Builder setMaxImageWidthWeight(Float f5) {
