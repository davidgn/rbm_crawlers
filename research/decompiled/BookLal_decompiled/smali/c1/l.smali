...
.method public constructor <init>(Li1/g;I)V
    ...
    iput-object p1, p0, Lc1/l;->a:Li1/g;
...
.method public final b()V
    ...
    iget-object v0, p0, Lc1/l;->d:Ljava/io/InputStream;
    ...
    :catch_0
    :cond_0
    iget-object v0, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
...
.method public final c(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    iput-object p3, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
    ...
    :cond_2
    iget-object p3, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
    ...
    iput-object p3, p0, Lc1/l;->d:Ljava/io/InputStream;

    iget-boolean p3, p0, Lc1/l;->e:Z
    ...
    iget-object p1, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
    ...
    invoke-direct {p4, p1, p2, p3}, Ly1/d;-><init>(Ljava/io/InputStream;J)V

    iput-object p4, p0, Lc1/l;->d:Ljava/io/InputStream;
    ...
    iput-object p1, p0, Lc1/l;->d:Ljava/io/InputStream;

    :goto_2
    iget-object p1, p0, Lc1/l;->d:Ljava/io/InputStream;
    ...
    invoke-virtual {p0}, Lc1/l;->b()V

    add-int/2addr p2, v2

    invoke-virtual {p0, v0, p2, p1, p4}, Lc1/l;->c(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    iget-object p2, p0, Lc1/l;->c:Ljava/net/HttpURLConnection;
...
.method public final d(Lcom/bumptech/glide/d;Lc1/d;)V
    ...
    iget-object p1, p0, Lc1/l;->a:Li1/g;
    ...
    :try_start_0
    invoke-virtual {p1}, Li1/g;->d()Ljava/net/URL;

    move-result-object v5

    iget-object p1, p1, Li1/g;->b:Li1/k;

    invoke-virtual {p1}, Li1/k;->b()Ljava/util/Map;
    ...
    invoke-virtual {p0, v5, v6, v7, p1}, Lc1/l;->c(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
