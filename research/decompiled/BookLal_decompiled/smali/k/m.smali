...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lk/m;->u:Z

    iput-boolean v0, p0, Lk/m;->v:Z

    iput-boolean v0, p0, Lk/m;->w:Z

    iput-boolean v0, p0, Lk/m;->x:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lk/m;->y:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v1, p0, Lk/m;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p0, Lk/m;->l:Ljava/util/ArrayList;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lk/m;->m:Z

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lk/m;->n:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lk/m;->o:Ljava/util/ArrayList;

    iput-boolean v2, p0, Lk/m;->p:Z
    ...
    invoke-static {v1}, LM/c0;->b(Landroid/view/ViewConfiguration;)Z
...
# virtual methods
.method public a(IIILjava/lang/CharSequence;)Lk/o;
    .locals 10
...
.method public final addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    iput-object v3, v4, Lk/o;->l:Landroid/content/Intent;
...
.method public final b(Lk/z;Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lk/m;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-interface {p1, p2, p0}, Lk/z;->k(Landroid/content/Context;Lk/m;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lk/m;->p:Z
...
.method public final c(Z)V
    ...
    :cond_1
    invoke-interface {v3, p0, p1}, Lk/z;->c(Lk/m;Z)V
...
.method public final clearHeader()V
    ...
    iput-object v0, p0, Lk/m;->s:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Lk/m;->r:Ljava/lang/CharSequence;

    iput-object v0, p0, Lk/m;->t:Landroid/view/View;
...
.method public d(Lk/o;)Z
    ...
    :cond_2
    invoke-interface {v4, p1}, Lk/z;->e(Lk/o;)Z
...
.method public e(Lk/m;Landroid/view/MenuItem;)Z
    ...
    invoke-interface {v0, p1, p2}, Lk/k;->f(Lk/m;Landroid/view/MenuItem;)Z
...
.method public f(Lk/o;)Z
    ...
    :cond_2
    invoke-interface {v4, p1}, Lk/z;->b(Lk/o;)Z
...
.method public final g(ILandroid/view/KeyEvent;)Lk/o;
    ...
    iget-object v0, p0, Lk/m;->y:Ljava/util/ArrayList;
    ...
    iget-char v8, v7, Lk/o;->o:C

    goto :goto_1

    :cond_2
    iget-char v8, v7, Lk/o;->m:C
...
.method public final h(Ljava/util/ArrayList;ILandroid/view/KeyEvent;)V
    ...
    iget-object v13, v12, Lk/o;->t:Lk/F;
    ...
    iget-char v13, v12, Lk/o;->o:C

    goto :goto_1

    :cond_2
    iget-char v13, v12, Lk/o;->m:C

    :goto_1
    if-eqz v3, :cond_3

    iget v14, v12, Lk/o;->p:I

    goto :goto_2

    :cond_3
    iget v14, v12, Lk/o;->n:I
...
.method public final i()V
    ...
    :cond_0
    iget-object v1, p0, Lk/m;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_2
    iget-object v1, p0, Lk/m;->n:Ljava/util/ArrayList;

    iget-object v2, p0, Lk/m;->o:Ljava/util/ArrayList;
...
.method public final l()Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, Lk/m;->m:Z

    iget-object v1, p0, Lk/m;->l:Ljava/util/ArrayList;
...
.method public p(Z)V
    ...
    iput-boolean v1, p0, Lk/m;->m:Z

    iput-boolean v1, p0, Lk/m;->p:Z
    ...
    :cond_2
    invoke-interface {v3, p1}, Lk/z;->g(Z)V
...
.method public final performIdentifierAction(II)Z
    ...
    invoke-virtual {p0, p1, v0, p2}, Lk/m;->q(Landroid/view/MenuItem;Lk/z;I)Z
...
.method public final performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lk/m;->q(Landroid/view/MenuItem;Lk/z;I)Z
...
.method public final q(Landroid/view/MenuItem;Lk/z;I)Z
    ...
    :cond_0
    iget-object v1, p1, Lk/o;->u:Landroid/view/MenuItem$OnMenuItemClickListener;
    ...
    :cond_2
    iget-object v3, p1, Lk/o;->l:Landroid/content/Intent;
    ...
    :cond_3
    iget-object v1, p1, Lk/o;->F:Lk/p;

    if-eqz v1, :cond_4

    iget-object v1, v1, Lk/p;->a:Landroid/view/ActionProvider;
    ...
    :goto_1
    iget-object v3, p1, Lk/o;->F:Lk/p;

    if-eqz v3, :cond_5

    iget-object v4, v3, Lk/p;->a:Landroid/view/ActionProvider;
    ...
    invoke-direct {p3, v5, p0, p1}, Lk/F;-><init>(Landroid/content/Context;Lk/m;Lk/o;)V

    iput-object p3, p1, Lk/o;->t:Lk/F;

    iget-object v5, p1, Lk/o;->e:Ljava/lang/CharSequence;

    invoke-virtual {p3, v5}, Lk/F;->setHeaderTitle(Ljava/lang/CharSequence;)Landroid/view/SubMenu;

    :cond_a
    iget-object p1, p1, Lk/o;->t:Lk/F;

    if-eqz v4, :cond_b

    iget-object p3, v3, Lk/p;->b:Lk/t;

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p3, v3, Lk/p;->a:Landroid/view/ActionProvider;

    invoke-virtual {p3, p1}, Landroid/view/ActionProvider;->onPrepareSubMenu(Landroid/view/SubMenu;)V

    :cond_b
    iget-object p3, p0, Lk/m;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-interface {p2, p1}, Lk/z;->d(Lk/F;)Z
    ...
    invoke-interface {v4, p1}, Lk/z;->d(Lk/F;)Z
...
.method public final setGroupCheckable(IZZ)V
    ...
    invoke-virtual {v3, p3}, Lk/o;->g(Z)V

    invoke-virtual {v3, p2}, Lk/o;->setCheckable(Z)Landroid/view/MenuItem;
...
.method public final t(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v3}, Lk/z;->getId()I
    ...
    invoke-interface {v3, v2}, Lk/z;->j(Landroid/os/Parcelable;)V
...
.method public final u(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, Lk/m;->u(Landroid/os/Bundle;)V
...
.method public final v(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v4}, Lk/z;->getId()I

    move-result v3

    if-lez v3, :cond_1

    invoke-interface {v4}, Lk/z;->m()Landroid/os/Parcelable;
...
.method public final w(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p5, p0, Lk/m;->t:Landroid/view/View;
    ...
    iput-object p1, p0, Lk/m;->r:Ljava/lang/CharSequence;
    ...
    iput-object p2, p0, Lk/m;->r:Ljava/lang/CharSequence;
    ...
    invoke-static {p1, p3}, LC/i;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Lk/m;->s:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p4, p0, Lk/m;->s:Landroid/graphics/drawable/Drawable;
