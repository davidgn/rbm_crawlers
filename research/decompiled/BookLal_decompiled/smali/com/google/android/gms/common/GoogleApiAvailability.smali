...
.method public showErrorDialogFragment(Landroid/app/Activity;ILe/c;Landroid/content/DialogInterface$OnCancelListener;)Z
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v5, p0, p1, p2, p3}, Lcom/google/android/gms/common/zac;-><init>(Lcom/google/android/gms/common/GoogleApiAvailability;Landroid/app/Activity;ILe/c;)V
...
.method public final zad(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p2, p1, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroidx/fragment/app/Y;Ljava/lang/String;)V
...
.method public final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p2, p3, v0}, LC/a;->h(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, p1, v4}, LB/x;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    const/4 v4, 0x1

    iput-boolean v4, v3, LB/x;->m:Z

    const/16 v5, 0x10

    invoke-virtual {v3, v5, v4}, LB/x;->c(IZ)V

    invoke-static {p3}, LB/x;->b(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object p3

    iput-object p3, v3, LB/x;->e:Ljava/lang/CharSequence;

    new-instance p3, LB/v;

    invoke-direct {p3}, Ljava/lang/Object;-><init>()V

    invoke-static {v0}, LB/x;->b(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v5

    iput-object v5, p3, LB/v;->b:Ljava/lang/CharSequence;

    invoke-virtual {v3, p3}, LB/x;->d(LB/y;)V
    ...
    iget-object v0, v3, LB/x;->s:Landroid/app/Notification;
    ...
    iget-object v1, v3, LB/x;->b:Ljava/util/ArrayList;

    new-instance v6, LB/r;

    invoke-direct {v6, p3, v0, p4}, LB/r;-><init>(ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_3
    iput-object p4, v3, LB/x;->g:Landroid/app/PendingIntent;

    goto :goto_0

    :cond_4
    iget-object p3, v3, LB/x;->s:Landroid/app/Notification;
    ...
    iget-object v1, v3, LB/x;->s:Landroid/app/Notification;
    ...
    iput-object p3, v3, LB/x;->f:Ljava/lang/CharSequence;
    ...
    :cond_7
    :goto_1
    iput-object p4, v3, LB/x;->q:Ljava/lang/String;

    :goto_2
    invoke-virtual {v3}, LB/x;->a()Landroid/app/Notification;
