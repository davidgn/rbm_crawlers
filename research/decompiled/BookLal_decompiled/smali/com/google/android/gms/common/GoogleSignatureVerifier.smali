...
.method public static final zza(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/ads/internal/util/a;->c(Landroid/content/pm/PackageInfo;)Landroid/content/pm/SigningInfo;

    move-result-object v3

    if-eqz v3, :cond_c

    invoke-static {v3}, Lcom/google/android/gms/ads/internal/util/a;->g(Landroid/content/pm/SigningInfo;)Z

    move-result v4

    if-nez v4, :cond_c

    invoke-static {v3}, Lcom/google/android/gms/ads/internal/util/a;->h(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
