...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lu0/V;->l:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->H0:LI0/c;

    iput-object v0, p0, Lu0/V;->d:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lu0/V;->e:Z

    iput-boolean v1, p0, Lu0/V;->f:Z
    ...
    iput-object v1, p0, Lu0/V;->c:Landroid/widget/OverScroller;
...
.method public final a(II)V
    ...
    iget-object v0, p0, Lu0/V;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput v1, p0, Lu0/V;->b:I

    iput v1, p0, Lu0/V;->a:I

    iget-object v1, p0, Lu0/V;->d:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->H0:LI0/c;

    if-eq v1, v2, :cond_0

    iput-object v2, p0, Lu0/V;->d:Landroid/view/animation/Interpolator;
    ...
    :cond_0
    iget-object v3, p0, Lu0/V;->c:Landroid/widget/OverScroller;
...
.method public final b()V
    ...
    iget-boolean v0, p0, Lu0/V;->e:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lu0/V;->f:Z
...
.method public final c(IIILandroid/view/animation/BaseInterpolator;)V
    ...
    iget-object v2, p0, Lu0/V;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->H0:LI0/c;

    :cond_4
    iget-object p3, p0, Lu0/V;->d:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Lu0/V;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Lu0/V;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v9, v0, Lu0/V;->l:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->r:Lu0/F;

    if-nez v1, :cond_0

    invoke-virtual {v9, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v1, v0, Lu0/V;->c:Landroid/widget/OverScroller;
    ...
    iput-boolean v10, v0, Lu0/V;->f:Z

    const/4 v11, 0x1

    iput-boolean v11, v0, Lu0/V;->e:Z

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView;->n()V

    iget-object v12, v0, Lu0/V;->c:Landroid/widget/OverScroller;
    ...
    iget v3, v0, Lu0/V;->a:I

    sub-int v3, v1, v3

    iget v4, v0, Lu0/V;->b:I

    sub-int v4, v2, v4

    iput v1, v0, Lu0/V;->a:I

    iput v2, v0, Lu0/V;->b:I
    ...
    :cond_2
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->q:Lu0/y;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->r:Lu0/F;

    iget-object v3, v3, Lu0/F;->e:Lu0/s;

    if-eqz v3, :cond_5

    iget-boolean v4, v3, Lu0/s;->d:Z

    if-nez v4, :cond_5

    iget-boolean v4, v3, Lu0/s;->e:Z

    if-eqz v4, :cond_5

    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->j0:Lu0/S;

    invoke-virtual {v4}, Lu0/S;->b()I

    move-result v4

    if-nez v4, :cond_3

    invoke-virtual {v3}, Lu0/s;->g()V

    goto :goto_0

    :cond_3
    iget v5, v3, Lu0/s;->a:I

    if-lt v5, v4, :cond_4

    sub-int/2addr v4, v11

    iput v4, v3, Lu0/s;->a:I

    invoke-virtual {v3, v1, v2}, Lu0/s;->e(II)V
    ...
    :goto_1
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->t:Ljava/util/ArrayList;
    ...
    :goto_5
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->r:Lu0/F;

    iget-object v2, v2, Lu0/F;->e:Lu0/s;

    if-eqz v2, :cond_10

    iget-boolean v2, v2, Lu0/s;->d:Z
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->i0:LS3/g;

    iget-object v2, v1, LS3/g;->d:Ljava/lang/Object;
    ...
    :cond_1b
    iput v10, v1, LS3/g;->c:I

    goto :goto_b

    :cond_1c
    :goto_a
    invoke-virtual/range {p0 .. p0}, Lu0/V;->b()V

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->h0:Lu0/k;

    if-eqz v1, :cond_1d

    invoke-virtual {v1, v9, v15, v14}, Lu0/k;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-boolean v2, v1, Lu0/s;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v10, v10}, Lu0/s;->e(II)V

    :cond_1e
    iput-boolean v10, v0, Lu0/V;->e:Z

    iget-boolean v1, v0, Lu0/V;->f:Z
