...
.method static constructor <clinit>()V
    ...
    const-class v19, Lk4/k;

    const-class v20, Lk4/m;
    ...
    const-class v3, Lk4/p;

    const-class v4, Lk4/q;

    const-class v5, Lk4/r;

    const-class v6, Lk4/s;

    const-class v7, Lk4/t;

    const-class v8, Lk4/u;

    const-class v9, Lk4/v;

    const-class v10, Lk4/b;

    const-class v11, Lk4/c;

    const-class v12, Lk4/d;

    const-class v13, Lk4/e;

    const-class v14, Lk4/f;

    const-class v15, Lk4/g;

    const-class v16, Lk4/h;

    const-class v17, Lk4/i;

    const-class v18, Lk4/j;

    const-class v21, Lk4/n;

    const-class v22, Lk4/o;

    filled-new-array/range {v0 .. v22}, [Ljava/lang/Class;

    move-result-object v0

    invoke-static {v0}, LZ3/h;->Z([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {v5, v3, v2}, LY3/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_1
    invoke-static {v1}, LZ3/s;->N(Ljava/util/ArrayList;)Ljava/util/Map;
    ...
    invoke-static {v1}, Ls4/e;->c0(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Ls4/e;->c0(Ljava/lang/String;)Ljava/lang/String;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, LS4/b;->s(Lq4/c;)Ljava/lang/Class;

    move-result-object v0

    check-cast p1, Lq4/c;

    invoke-static {p1}, LS4/b;->s(Lq4/c;)Ljava/lang/Class;
