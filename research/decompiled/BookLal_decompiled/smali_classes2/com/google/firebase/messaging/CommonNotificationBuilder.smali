...
.method public static createNotificationInfo(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/NotificationParams;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;
    ...
    invoke-direct {v3, p1, p3}, LB/x;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v4, v3, LB/x;->f:Ljava/lang/CharSequence;
    ...
    iput-object p3, v4, LB/v;->b:Ljava/lang/CharSequence;

    .line 19
    invoke-virtual {v3, v4}, LB/x;->d(LB/y;)V
    ...
    .line 23
    iget-object v4, v3, LB/x;->s:Landroid/app/Notification;
    ...
    .line 28
    invoke-static {p3, v1}, LB/w;->c(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;
    ...
    .line 29
    invoke-static {p3, v5}, LB/w;->e(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;

    move-result-object p3

    .line 30
    invoke-static {p3}, LB/w;->a(Landroid/media/AudioAttributes$Builder;)Landroid/media/AudioAttributes;
    ...
    .line 32
    iput-object p3, v3, LB/x;->g:Landroid/app/PendingIntent;
    ...
    .line 40
    invoke-virtual {v3, p3, p0}, LB/x;->c(IZ)V
    ...
    invoke-static {p0}, LB/x;->b(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    .line 57
    iget-object p0, v3, LB/x;->s:Landroid/app/Notification;
    ...
    .line 62
    iget-object v2, v3, LB/x;->s:Landroid/app/Notification;
    ...
    .line 68
    iget-object p4, v3, LB/x;->s:Landroid/app/Notification;
    ...
    invoke-direct {p0, v3, p1, p3}, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;-><init>(LB/x;Ljava/lang/String;I)V
...
.method private static getColor(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    :try_start_1
    invoke-static {p0, p1}, LC/i;->getColor(Landroid/content/Context;I)I
