...
.method private showNotification(Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;)V
    ...
    iget-object p1, p1, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:LB/x;

    invoke-virtual {p1}, LB/x;->a()Landroid/app/Notification;
...
.method private waitForAndApplyImageDownload(LB/x;Lcom/google/firebase/messaging/ImageDownload;)V
    .locals 6
    ...
    :goto_0
    iput-object v4, p1, LB/x;->h:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_1
    iput-object v5, v4, LB/u;->b:Landroidx/core/graphics/drawable/IconCompat;

    iput-object v3, v4, LB/u;->c:Landroidx/core/graphics/drawable/IconCompat;

    iput-boolean v2, v4, LB/u;->d:Z

    invoke-virtual {p1, v4}, LB/x;->d(LB/y;)V
    :try_end_0
...
.method public handleNotification()Z
    ...
    iget-object v3, v2, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:LB/x;

    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/DisplayNotification;->waitForAndApplyImageDownload(LB/x;Lcom/google/firebase/messaging/ImageDownload;)V
