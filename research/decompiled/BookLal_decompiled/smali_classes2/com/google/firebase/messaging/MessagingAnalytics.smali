...
.method public static logNotificationReceived(Landroid/content/Intent;)V
    ...
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()LP1/f;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/MessagingAnalytics;->logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;LP1/f;)V

    :cond_1
    return-void
.end method

.method private static logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;LP1/f;)V
    .locals 4
    ...
    invoke-direct {v2, v1}, LP1/b;-><init>(Ljava/lang/String;)V

    new-instance v1, Lcom/google/firebase/inappmessaging/internal/k;

    const/16 v3, 0xb

    invoke-direct {v1, v3}, Lcom/google/firebase/inappmessaging/internal/k;-><init>(I)V

    check-cast p2, LS1/r;

    invoke-virtual {p2, p1, v2, v1}, LS1/r;->a(Ljava/lang/String;LP1/b;LP1/d;)LC4/E;
    ...
    invoke-direct {p2, p0}, LP1/a;-><init>(Ljava/lang/Object;)V

    invoke-virtual {p1, p2}, LC4/E;->n(LP1/a;)V
    :try_end_0
