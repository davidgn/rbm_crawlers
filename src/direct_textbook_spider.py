...
class DirectTextbookSpider(HTMLSearchSpider):
    """Broad crawler for DirectTextbook (Egypt)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="DirectTextbook",
            territory="Egypt",
            base_url="https://www.directtextbook.com",
            search_path="isbn/{search_term}",
            currency="EGP",
