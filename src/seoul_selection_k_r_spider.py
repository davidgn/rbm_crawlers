...
class SeoulSelectionKRSpider(HTMLSearchSpider):
    """Broad crawler for Seoul Selection (KR) (South Korea)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Seoul Selection (KR)",
            territory="South Korea",
            base_url="www.seoulselection.com",
