...
class CoinAfriqueSpider(HTMLSearchSpider):
    ...
    def __init__(self, search_term: str = "livres", country_code: str = "SN", limit_pages: int = 50, limit_items: int | None = None):
...
if __name__ == "__main__":
    ...
    spider = CoinAfriqueSpider(search_term=args.query, country_code=args.country, limit_pages=args.limit_pages, limit_items=args.limit_items)
    spider.run()
