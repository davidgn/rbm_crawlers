...
class LibreriaVidaCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Vida (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Vida (CO)",
            territory="Colombia",
            base_url="https://co.ppc-editorial.com",
            search_path="libreria/libreria-vida?q={search_term}",
            currency="COP",
