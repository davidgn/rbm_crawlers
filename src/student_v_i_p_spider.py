...
class StudentVIPSpider(HTMLSearchSpider):
    """Broad crawler for StudentVIP (Peru)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="StudentVIP",
            territory="Peru",
            base_url="https://studentvip.com.au",
            search_path="textbooks?q={search_term}",
            currency="PEN",
