...
class PensamientoEscritoCOSpider(HTMLSearchSpider):
    """Broad crawler for Pensamiento Escrito (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Pensamiento Escrito (CO)",
            territory="Colombia",
            base_url="https://www.pensamientoescrito.com",
