...
class CaroYCuervoCOSpider(HTMLSearchSpider):
    """Broad crawler for Caro y Cuervo (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Caro y Cuervo (CO)",
            territory="Colombia",
            base_url="https://www.caroycuervo.gov.co",
            search_path="publicaciones?search={search_term}",
            currency="COP",
