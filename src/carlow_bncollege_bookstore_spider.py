...
class CarlowBookstoreSpider(PlaywrightSearchSpider):
    """Playwright-based spider for Carlow Bookstore (BN College platform)."""

    def __init__(self, limit_pages: int = 5, limit_items: int | None = None, **kwargs):
        super().__init__(
            platform_name="Carlow Bookstore",
            base_url="https://carlow.bncollege.com",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Carlow Bookstore Playwright Spider")
    parser.add_argument("--query", type=str, default="textbook")
    parser.add_argument("--limit-pages", type=int, default=1)
    parser.add_argument("--limit-items", type=int, default=5)
    args, _ = parser.parse_known_args()
    spider = CarlowBookstoreSpider(limit_pages=args.limit_pages, limit_items=args.limit_items)
