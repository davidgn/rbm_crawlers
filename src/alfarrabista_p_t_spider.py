...
class AlfarrabistaPTSpider(HTMLSearchSpider):
    """Broad crawler for Alfarrabista (PT) (Portugal)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Alfarrabista (PT)",
            territory="Portugal",
            base_url="www.alfarrabista.pt",
            search_path="pesquisa.php?q={search_term}",
            currency="EUR",
