...
class BiblioIeSpider(FlaresolverrSearchSpider):
    """
    Spider for Biblio Ireland using Flaresolverr to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Biblio Ireland Flaresolverr Spider")
