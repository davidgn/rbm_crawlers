...
class BiblioIeSpider(NodriverSearchSpider):
    """
    Spider for Biblio Ireland using nodriver to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Biblio Ireland nodriver Spider")
