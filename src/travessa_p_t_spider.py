...
class TravessaPTSpider(HTMLSearchSpider):
    """Broad crawler for Livraria da Travessa (PT) (Portugal)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Livraria da Travessa (PT)",
            territory="Portugal",
            base_url="www.travessa.pt",
            search_path="busca?q={search_term}",
            currency="EUR",
