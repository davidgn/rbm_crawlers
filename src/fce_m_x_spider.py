...
class FceMXSpider(HTMLSearchSpider):
    """Broad crawler for FCE (MX/LATAM) (Mexico)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="FCE (MX/LATAM)",
            territory="Mexico",
            base_url="https://www.fondodeculturaeconomica.com",
            search_path="Busqueda/basica?txtbuscar={search_term}",
            currency="MXN",
