...
class TiemposFuturosCOSpider(HTMLSearchSpider):
    """Broad crawler for Tiempos Futuros (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Tiempos Futuros (CO)",
            territory="Colombia",
            base_url="https://tiemposfuturoslibreria.com",
