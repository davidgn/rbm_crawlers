...
class BertrandPTSpider(NodriverSearchSpider):
    """Broad crawler for Bertrand (PT) (Portugal)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Bertrand (PT)",
            territory="Portugal",
            base_url="www.bertrand.pt",
            search_path="pesquisa/{search_term}",
            currency="EUR",
