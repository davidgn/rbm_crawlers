...
class SwiatKsiazkiPLSpider(HTMLSearchSpider):
    """Broad crawler for SwiatKsiazki (PL) (Poland)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="SwiatKsiazki (PL)",
            territory="Poland",
            base_url="www.swiatksiazki.pl",
