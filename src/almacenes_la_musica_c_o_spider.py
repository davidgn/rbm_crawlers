...
class AlmacenesLaMusicaCOSpider(HTMLSearchSpider):
    """Broad crawler for Almacenes la Música (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Almacenes la Música (CO)",
            territory="Colombia",
            base_url="https://www.lamusica.com.co",
