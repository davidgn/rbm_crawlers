...
class AgoraCafeLibroCOSpider(HTMLSearchSpider):
    """Broad crawler for Ágora Café Libro (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Ágora Café Libro (CO)",
            territory="Colombia",
            base_url="https://www.agoralibreria.com",
