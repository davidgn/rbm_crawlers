"""
ZVAB Austria spider — ZVAB.com is an AbeBooks sister marketplace for
German-speaking antiquarian book dealers, with a strong Austrian presence.

Same microdata backend as AbeBooks.de/ZVAB Germany. Search terms target
Austrian publishers and cultural contexts to surface Austrian-market sellers.
"""
import argparse
import re
import time
...
CONFIG = SimpleNamespace(platform_name="ZVAB Austria", territory="Austria")
...
class ZVABAustriaSpider(BaseSpider):
    ...
    def __init__(
        ...
        super().__init__(platform_name="ZVAB Austria", territory="Austria")
        self.delay = delay
...
def main():
    parser = argparse.ArgumentParser(description="ZVAB Austria antiquarian books spider")
