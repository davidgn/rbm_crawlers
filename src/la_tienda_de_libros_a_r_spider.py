...
class LaTiendaDeLibrosARSpider(HTMLSearchSpider):
    """Broad crawler for La Tienda de Libros (AR) (Argentina) - Tiendanube."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="La Tienda de Libros (AR)",
            territory="Argentina",
            base_url="https://latiendadelibros.mitiendanube.com",
