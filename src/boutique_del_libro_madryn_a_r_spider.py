...
class BoutiqueDelLibroMadrynARSpider(HTMLSearchSpider):
    """Broad crawler for Boutique del Libro Madryn (AR) (Argentina) - Tiendanube."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Boutique del Libro Madryn (AR)",
            territory="Argentina",
            base_url="https://boutiquedellibromadryn.mitiendanube.com",
...
if __name__ == "__main__":
    ...
    BoutiqueDelLibroMadrynARSpider(
