...
class UrduBazarPKSpider(NodriverSearchSpider):
    """Broad crawler for Urdu Bazar Online (PK) (Pakistan)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Urdu Bazar Online (PK)",
            territory="Pakistan",
            base_url="urdubazaronline.com",
