...
class AlaDeColibriCOSpider(HTMLSearchSpider):
    """Broad crawler for Ala de Colibrí (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Ala de Colibrí (CO)",
            territory="Colombia",
            base_url="https://aladecolibrilibreria.com",
