...
class DushiBooksCOSpider(HTMLSearchSpider):
    """Broad crawler for Dushi Books (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Dushi Books (CO)",
            territory="Colombia",
            base_url="https://dushibooks.mitiendanube.com",
