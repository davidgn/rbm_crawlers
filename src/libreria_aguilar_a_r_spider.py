...
class LibreriaAguilarARSpider(HTMLSearchSpider):
    """Broad crawler for Librería Aguilar (AR) (Argentina) - Tiendanube."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Aguilar (AR)",
            territory="Argentina",
            base_url="https://libreriaaguilar.com.ar",
