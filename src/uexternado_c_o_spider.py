...
class UexternadoCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Externado (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Externado (CO)",
            territory="Colombia",
            base_url="https://www.uexternado.edu.co",
