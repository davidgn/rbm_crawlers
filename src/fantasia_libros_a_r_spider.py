...
class FantasiaLibrosARSpider(HTMLSearchSpider):
    """Broad crawler for Fantasía Libros (AR) (Argentina) - Tiendanube."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Fantasía Libros (AR)",
            territory="Argentina",
            base_url="https://fantasia.com.ar",
