...
class RosarioCOSpider(HTMLSearchSpider):
    """Broad crawler for Editorial Rosario (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Editorial Rosario (CO)",
            territory="Colombia",
            base_url="https://editorial.urosario.edu.co",
