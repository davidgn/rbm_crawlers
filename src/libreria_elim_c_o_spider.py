...
class LibreriaElimCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Elim (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Elim (CO)",
            territory="Colombia",
            base_url="https://libreriaelim.co",
