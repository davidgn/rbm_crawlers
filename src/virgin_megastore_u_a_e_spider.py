...
class VirginMegastoreUAESpider(HTMLSearchSpider):
    """Broad crawler for Virgin Megastore (UAE) (UAE)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Virgin Megastore (UAE)",
            territory="UAE",
            base_url="www.virginmegastore.ae",
            search_path="en/search/?text={search_term}",
            currency="AED",
