...
class LibreriaGrammataCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Grammata (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Grammata (CO)",
            territory="Colombia",
            base_url="https://libreriagrammata.com",
