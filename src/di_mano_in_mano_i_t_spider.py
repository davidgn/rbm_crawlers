...
class DiManoInManoITSpider(HTMLSearchSpider):
    """Broad crawler for Di Mano in Mano (IT) (Italy)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Di Mano in Mano (IT)",
            territory="Italy",
            base_url="www.dimanoinmano.it",
            search_path="it/ricerca?q={search_term}",
            currency="EUR",
