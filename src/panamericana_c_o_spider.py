...
class PanamericanaCOSpider(VtexSearchSpider):
    """Broad crawler for Panamericana (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Panamericana (CO)",
            host="www.panamericana.com.co",
            territory="Colombia",
