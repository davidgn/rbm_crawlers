...
class FullyBookedPHSpider(HTMLSearchSpider):
    """Broad crawler for Fully Booked (PH) (Philippines)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Fully Booked (PH)",
            territory="Philippines",
            base_url="www.fullybookedonline.com",
