    ...
    def __init__(self, limit_pages: int = 5, limit_items: int | None = None, **kwargs):
        ...
        super().__init__(
            ...
            selectors={
                ...
                'title': '.product-title, .product-card-title, h3.product-title, h3.product-card-title, a.product-title, a[class*="title"], [class*="product-title"], a.name, .name',
                'link': 'a.product-title, .product-title a, a[class*="title"], [class*="product-title"] a, a.name, .name a, a[class*="name"]',
