...
class LibreriaLaCinglaCOSpider(HTMLSearchSpider):
    """Broad crawler for La Cingla (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="La Cingla (CO)",
            territory="Colombia",
            base_url="https://librerialacingla.com",
