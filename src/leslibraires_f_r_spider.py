...
class LesLibrairesFRSpider(HTMLSearchSpider):
    """Broad crawler for LesLibraires.fr (FR) (France)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="LesLibraires.fr (FR)",
            territory="France",
            base_url="www.leslibraires.fr",
