...
class PeegrinaLibrosCOSpider(HTMLSearchSpider):
    """Broad crawler for Peregrina Libros (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Peregrina Libros (CO)",
            territory="Colombia",
            base_url="https://peregrinalibros.com.co",
