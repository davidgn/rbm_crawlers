...
class WeBuyBooksSpider(NodriverSearchSpider):
    """
    Spider for WeBuyBooks UK using nodriver to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="WeBuyBooks nodriver Spider")
