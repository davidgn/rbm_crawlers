...
class MedicaPanamericanaCOSpider(HTMLSearchSpider):
    """Broad crawler for Médica Panamericana (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Médica Panamericana (CO)",
            territory="Colombia",
            base_url="https://www.medicapanamericana.com",
