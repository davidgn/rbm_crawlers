...
class LeyaOnlinePTSpider(HTMLSearchSpider):
    """Broad crawler for Leya Online (PT) (Portugal)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Leya Online (PT)",
            territory="Portugal",
            base_url="www.leyaonline.com",
            search_path="pt/pesquisa/?q={search_term}",
            currency="EUR",
