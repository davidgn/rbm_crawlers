...
class UscoCOSpider(HTMLSearchSpider):
    """Broad crawler for Editorial USCO (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Editorial USCO (CO)",
            territory="Colombia",
            base_url="https://usco.edu.co",
            search_path="oficina-editorial/?q={search_term}",
            currency="COP",
