...
class VogAndWodNGSpider(HTMLSearchSpider):
    """Broad crawler for Vog and Wod Bookstore (NG) (Nigeria)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Vog and Wod Bookstore (NG)",
            territory="Nigeria",
            base_url="vogandwodbooks.com",
