...
class VillegasEditoresCOSpider(HTMLSearchSpider):
    """Broad crawler for Villegas Editores (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Villegas Editores (CO)",
            territory="Colombia",
            base_url="https://www.villegaseditores.com",
