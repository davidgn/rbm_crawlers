...
class LaHoraDelCuentoCOSpider(HTMLSearchSpider):
    """Broad crawler for La hora del cuento (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="La hora del cuento (CO)",
            territory="Colombia",
            base_url="https://librerialahoradelcuento.com",
