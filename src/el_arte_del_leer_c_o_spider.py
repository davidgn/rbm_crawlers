...
class ElArteDelLeerCOSpider(HTMLSearchSpider):
    """Broad crawler for El Arte del Leer (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="El Arte del Leer (CO)",
            territory="Colombia",
            base_url="https://www.elartedeleer.com.co",
