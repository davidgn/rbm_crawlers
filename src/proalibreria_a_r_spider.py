...
class ProalibreriaARSpider(HTMLSearchSpider):
    """Broad crawler for Proalibreria (AR) (Argentina) - Tiendanube."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Proalibreria (AR)",
            territory="Argentina",
            base_url="https://proalibreria.mitiendanube.com",
