...
class RegikonyvekSpider(HTMLSearchSpider):
    """Broad crawler for Regikonyvek (HU) (Egypt)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Regikonyvek (HU)",
            territory="Egypt",
            base_url="https://www.regikonyvek.hu",
            search_path="konyvfelvasarlas?q={search_term}",
            currency="EGP",
