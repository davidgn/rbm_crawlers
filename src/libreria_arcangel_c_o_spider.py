...
class LibreriaArcangelCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Arcángel (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Arcángel (CO)",
            territory="Colombia",
            base_url="https://libreriaarcangel.com",
            search_path="web/busqueda?q={search_term}",
            currency="COP",
