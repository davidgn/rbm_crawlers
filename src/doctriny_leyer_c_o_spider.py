...
class DoctrinyLeyerCOSpider(HTMLSearchSpider):
    """Broad crawler for Doctrina y Ley (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Doctrina y Ley (CO)",
            territory="Colombia",
            base_url="https://www.doctrinayley.com",
