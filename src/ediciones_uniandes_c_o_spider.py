...
class EdicionesUniandesCOSpider(HTMLSearchSpider):
    """Broad crawler for Ediciones Uniandes (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Ediciones Uniandes (CO)",
            territory="Colombia",
            base_url="https://ediciones.uniandes.edu.co",
