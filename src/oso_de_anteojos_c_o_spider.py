...
class OsoDeAnteojosCOSpider(HTMLSearchSpider):
    """Broad crawler for Oso de Anteojos (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Oso de Anteojos (CO)",
            territory="Colombia",
            base_url="https://www.osodeanteojostiendadelibros.com.co",
