...
class BrightonStudentsUnionSpider(PlaywrightSearchSpider):
    """Playwright-based spider for Brighton Students Union (MSL platform)."""

    def __init__(self, limit_pages: int = 5, limit_items: int | None = None, **kwargs):
        super().__init__(
            platform_name="Brighton Students Union",
            base_url="https://www.brightonsu.com",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Brighton Students Union Playwright Spider")
    parser.add_argument("--query", type=str, default="textbook")
    parser.add_argument("--limit-pages", type=int, default=1)
    parser.add_argument("--limit-items", type=int, default=5)
    args, _ = parser.parse_known_args()
    spider = BrightonStudentsUnionSpider(limit_pages=args.limit_pages, limit_items=args.limit_items)
