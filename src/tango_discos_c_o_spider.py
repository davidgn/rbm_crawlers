...
class TangoDiscosCOSpider(HTMLSearchSpider):
    """Broad crawler for Tango Discos y Libros (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Tango Discos y Libros (CO)",
            territory="Colombia",
            base_url="https://tangodiscos.co",
