...
class TiendaUisCOSpider(HTMLSearchSpider):
    """Broad crawler for Tienda UIS (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Tienda UIS (CO)",
            territory="Colombia",
            base_url="https://uis.edu.co",
            search_path="uis-publicaciones-tienda-universitaria-es?q={search_term}",
            currency="COP",
