...
class AlPiedeLaLetraCOSpider(HTMLSearchSpider):
    """Broad crawler for Al Pie de la Letra (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Al Pie de la Letra (CO)",
            territory="Colombia",
            base_url="https://www.alpiedelaletralibreria.com",
