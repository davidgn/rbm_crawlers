...
class CaminoACasaLibreriaCOSpider(HTMLSearchSpider):
    """Broad crawler for Camino a Casa Librería (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Camino a Casa Librería (CO)",
            territory="Colombia",
            base_url="https://www.caminoacasalibreria.com",
