...
class TantaTintaCOSpider(HTMLSearchSpider):
    """Broad crawler for Tanta Tinta (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Tanta Tinta (CO)",
            territory="Colombia",
            base_url="https://www.tantatintalibrosycafes.com",
