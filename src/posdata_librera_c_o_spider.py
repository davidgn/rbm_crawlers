...
class PosdataLibreraCOSpider(HTMLSearchSpider):
    """Broad crawler for Posdata Libros y Café (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Posdata Libros y Café (CO)",
            territory="Colombia",
            base_url="https://www.posdatalibreria.co",
