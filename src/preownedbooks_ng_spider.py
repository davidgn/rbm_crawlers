...
class PreownedBooksNgSpider(BaseSpider):
    """
    PreownedBooks.ng — Nigeria main-universe used-book marketplace.

    Nigerian peer-to-peer secondhand book buy/sell platform.  Captures ISBNs,
    ...
    BASE_URL = "https://www.preownedbooks.ng"
