...
class IukBookstoreSpider(PlaywrightSearchSpider):
    """Playwright-based spider for Iuk Bookstore (BN College platform)."""

    def __init__(self, limit_pages: int = 5, limit_items: int | None = None, **kwargs):
        super().__init__(
            platform_name="Iuk Bookstore",
            base_url="https://iuk.bncollege.com",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Iuk Bookstore Playwright Spider")
    parser.add_argument("--query", type=str, default="textbook")
    parser.add_argument("--limit-pages", type=int, default=1)
    parser.add_argument("--limit-items", type=int, default=5)
    args, _ = parser.parse_known_args()
    spider = IukBookstoreSpider(limit_pages=args.limit_pages, limit_items=args.limit_items)
