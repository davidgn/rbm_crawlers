...
class ExpresionVivaCOSpider(HTMLSearchSpider):
    """Broad crawler for Expresión Viva (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Expresión Viva (CO)",
            territory="Colombia",
            base_url="https://www.expresionviva.com",
