...
class LibreriaNacionalCOSpider(VtexSearchSpider):
    """Broad crawler for Librería Nacional (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Nacional (CO)",
            host="www.librerianacional.com",
            territory="Colombia",
