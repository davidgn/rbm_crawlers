...
class StmarysCaBookstoreSpider(PlaywrightSearchSpider):
    """Playwright-based spider for Stmarys Ca Bookstore (BN College platform)."""

    def __init__(self, limit_pages: int = 5, limit_items: int | None = None, **kwargs):
        super().__init__(
            platform_name="Stmarys Ca Bookstore",
            base_url="https://stmarys-ca.bncollege.com",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Stmarys Ca Bookstore Playwright Spider")
    parser.add_argument("--query", type=str, default="textbook")
    parser.add_argument("--limit-pages", type=int, default=1)
    parser.add_argument("--limit-items", type=int, default=5)
    args, _ = parser.parse_known_args()
    spider = StmarysCaBookstoreSpider(limit_pages=args.limit_pages, limit_items=args.limit_items)
