...
class BiblioGreeceSpider(FlaresolverrSearchSpider):
    """
    Spider for Biblio Greece using Flaresolverr to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Biblio Greece Flaresolverr Spider")
