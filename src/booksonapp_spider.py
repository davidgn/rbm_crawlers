...
class BooksOnAppSpider(BaseSpider):
    ...
    Playwright + stealth (React/SPA web surface).
    ...
    def __init__(self, limit_pages=100):
        ...
        self.base_url = "https://booksonapp.com"

    def run(self):
        self.logger.info(
            f"Starting BooksOnApp harvest (cache-first). limit_pages={self.limit_pages}"
        )
        seen: set[str] = set()
...
if __name__ == "__main__":
    ...
    BooksOnAppSpider(limit_pages=args.limit).run()
