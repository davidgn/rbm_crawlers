...
class KaitoriOujiSpider(HTMLSearchSpider):
    """Broad crawler for Kaitori Ouji (JP) (Japan)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Kaitori Ouji (JP)",
            territory="Japan",
            base_url="https://www.kaitoriouji.jp",
            search_path="item/book/",
            currency="JPY",
