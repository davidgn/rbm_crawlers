...
class AntikvarijatLibarSpider(HTMLSearchSpider):
    """Broad crawler for Antikvarijat Libar (HR) (Peru)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Antikvarijat Libar (HR)",
            territory="Peru",
            base_url="https://www.antikvarijat-libar.com",
