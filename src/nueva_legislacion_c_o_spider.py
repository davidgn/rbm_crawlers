...
class NuevaLegislacionCOSpider(HTMLSearchSpider):
    """Broad crawler for Nueva Legislación (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Nueva Legislación (CO)",
            territory="Colombia",
            base_url="https://www.nuevalegislacion.com",
