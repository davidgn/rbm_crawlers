...
class BostonCollegeBookstoreSpider(PlaywrightSearchSpider):
    """Playwright-based spider for Boston College Bookstore (BN College platform)."""

    def __init__(self, limit_pages: int = 5, limit_items: int | None = None, **kwargs):
        super().__init__(
            platform_name="Boston College Bookstore",
            base_url="https://bc.bncollege.com",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Boston College Bookstore Playwright Spider")
