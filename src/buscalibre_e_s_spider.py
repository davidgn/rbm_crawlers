...
class BuscalibreESSpider(HTMLSearchSpider):
    """Broad crawler for Buscalibre (ES) (Spain)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Buscalibre (ES)",
            territory="Spain",
            base_url="www.buscalibre.es",
            search_path="libros/search?q={search_term}",
            currency="EUR",
