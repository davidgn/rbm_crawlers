...
class ElHombreDeLaManchaCOSpider(HTMLSearchSpider):
    """Broad crawler for El Hombre de la Mancha (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="El Hombre de la Mancha (CO)",
            territory="Colombia",
            base_url="https://elhombredelamancha.com.co",
