...
class FnacPTSpider(NodriverSearchSpider):
    """
    Spider for FNAC Portugal using nodriver to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FNAC Portugal nodriver Spider")
