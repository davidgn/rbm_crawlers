...
class BoekenwereldNLSpider(HTMLSearchSpider):
    """Broad crawler for Boekenwereld (NL) (Netherlands)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Boekenwereld (NL)",
            territory="Netherlands",
            base_url="www.boekenwereld.com",
            search_path="zoeken?q={search_term}",
            currency="EUR",
