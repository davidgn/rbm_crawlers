...
class CasaDelLibroESSpider(HTMLSearchSpider):
    """Broad crawler for Casa del Libro (ES) (Spain)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Casa del Libro (ES)",
            territory="Spain",
            base_url="www.casadellibro.com",
            search_path="libros?q={search_term}",
            currency="EUR",
