...
class BetterWorldBooksSpider(NodriverSearchSpider):
    """Broad crawler for Better World Books (Saudi Arabia)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Better World Books",
            territory="Saudi Arabia",
            base_url="https://www.betterworldbooks.com",
            search_path="search/results?q={search_term}",
            currency="SAR",
