...
class LibreriaAcuarioCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Acuario (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Acuario (CO)",
            territory="Colombia",
            base_url="https://libreriaacuario.com.co",
