...
class FalabellaCOSpider(HTMLSearchSpider):
    """Broad crawler for Falabella (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Falabella (CO)",
            territory="Colombia",
            base_url="https://www.falabella.com.co",
            search_path="falabella-co/search?Ntt={search_term}",
            currency="COP",
