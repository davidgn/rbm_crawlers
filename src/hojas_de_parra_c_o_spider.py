...
class HojasDeParraCOSpider(HTMLSearchSpider):
    """Broad crawler for Hojas de Parra (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Hojas de Parra (CO)",
            territory="Colombia",
            base_url="https://www.hojasdeparra.com",
