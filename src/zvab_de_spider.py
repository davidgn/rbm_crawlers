"""
ZVAB Germany spider — ZVAB.com is an AbeBooks sister marketplace for
German-speaking antiquarian book dealers, with Germany as its primary market.

Same microdata backend as AbeBooks.de. Search terms target German publishers
and cultural contexts to surface German-market sellers.
"""
import argparse
import re
import time
...
CONFIG = SimpleNamespace(platform_name="ZVAB Germany", territory="Germany")
...
class ZVABGermanySpider(BaseSpider):
    ...
    def __init__(
        ...
        super().__init__(platform_name="ZVAB Germany", territory="Germany")
        self.delay = delay
...
def main():
    parser = argparse.ArgumentParser(description="ZVAB Germany antiquarian books spider")
