...
class MutanabiSpider(BaseSpider):
    """
    Mutanabi Shop / متجر شارع المتنبي (almutanabi.shop) — Iraq main-universe.

    Named after Baghdad's famous Al-Mutanabbi Street book market; online
    Arabic and English book retail platform.  Captures ISBNs, pricing, and
    ...
    BASE_URL = "https://www.almutanabi.shop"

    BROWSE_CANDIDATES = [
        "/product-category/books",
        "/product-category/كتب",
        "/books",
        "/shop",
        "/كتب",
        "/catalog",
    ...
    def __init__(self, limit_pages=100):
        super().__init__(platform_name="Mutanabi Shop", territory="Iraq")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Mutanabi Shop Iraq cache-first spider")
    parser.add_argument("--limit", type=int, default=100)
    args = parser.parse_args()
    MutanabiSpider(limit_pages=args.limit).run()
