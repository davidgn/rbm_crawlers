...
class TextbooksComSpider(NodriverSearchSpider):
    """Broad crawler for Textbooks.com (Colombia)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Textbooks.com",
            territory="Colombia",
            base_url="https://www.textbooks.com",
            search_path="sell-textbooks.php?q={search_term}",
            currency="COP",
