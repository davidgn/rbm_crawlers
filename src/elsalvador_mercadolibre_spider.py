...
class ElsalvadorMercadolibreSpider(HTMLSearchSpider):
    def __init__(self, limit_pages: int = 50):
        super().__init__(
            platform_name="MercadoLibre_SV", base_url="https://listado.mercadolibre.com.sv",
...
if __name__ == "__main__":
    ElsalvadorMercadolibreSpider(limit_pages=1).run()
