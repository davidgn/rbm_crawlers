...
class EdicionesConEspiritoCOSpider(HTMLSearchSpider):
    """Broad crawler for Ediciones con Espíritu (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Ediciones con Espíritu (CO)",
            territory="Colombia",
            base_url="https://edicionesconespiritu.com",
