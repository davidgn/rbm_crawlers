...
class SellitbackSpider(PlaywrightSearchSpider):
    """
    Spider for SellitBack UK using Playwright to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SellitBack Playwright Spider")
