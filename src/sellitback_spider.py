...
class SellitbackSpider(NodriverSearchSpider):
    """
    Spider for SellitBack UK using nodriver to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SellitBack nodriver Spider")
