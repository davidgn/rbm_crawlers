...
class UchicagoBookstoreUsedSpider(PlaywrightSearchSpider):
    """
    Playwright-based spider for UChicago Bookstore (BN College).
...
if __name__ == "__main__":
    ...
    spider = UchicagoBookstoreUsedSpider(limit_pages=args.limit_pages, limit_items=args.limit_items)
