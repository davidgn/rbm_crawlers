...
class ElTelarDeLasPalabrasCOSpider(HTMLSearchSpider):
    """Broad crawler for El Telar de las Palabras (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="El Telar de las Palabras (CO)",
            territory="Colombia",
            base_url="https://eltelardelaspalabras.com.co",
