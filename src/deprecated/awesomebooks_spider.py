...
class AwesomebooksSpider(NodriverSearchSpider):
    """
    Spider for AwesomeBooks using nodriver to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AwesomeBooks nodriver Spider")
