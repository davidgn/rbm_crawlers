...
class BookloopUkSpider(FlaresolverrSearchSpider):
    """
    Spider for Bookloop UK using Flaresolverr to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Bookloop UK Flaresolverr Spider")
