...
class ZapperSpider(FlaresolverrSearchSpider):
    """
    Spider for Zapper UK using Flaresolverr to bypass Cloudflare.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Zapper Flaresolverr Spider")
