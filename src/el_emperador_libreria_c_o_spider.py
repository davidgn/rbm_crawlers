...
class ElEmperadorLibreriaCOSpider(HTMLSearchSpider):
    """Broad crawler for El Emperador (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="El Emperador (CO)",
            territory="Colombia",
            base_url="https://elemperadorlibreria.com",
