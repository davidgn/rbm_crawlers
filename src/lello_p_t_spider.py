...
class LelloPTSpider(HTMLSearchSpider):
    """Broad crawler for Livraria Lello (PT) (Portugal)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Livraria Lello (PT)",
            territory="Portugal",
            base_url="www.livrarialello.pt",
            search_path="loja/pesquisa?q={search_term}",
            currency="EUR",
