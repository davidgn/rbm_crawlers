...
class ElTiempoCOSpider(HTMLSearchSpider):
    """Broad crawler for El Tiempo Libros (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="El Tiempo Libros (CO)",
            territory="Colombia",
            base_url="https://tienda.eltiempo.com",
            search_path="libros/buscar?q={search_term}",
            currency="COP",
