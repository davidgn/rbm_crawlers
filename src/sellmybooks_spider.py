...
class SellMyBooksSpider(BaseSpider):
    def __init__(self, limit_pages=10):
        ...
        self.base_url = "https://www.sellmybooks.com"
        self.limit_pages = limit_pages
        self.client = httpx.Client(timeout=30.0, follow_redirects=True)

    def run(self):
        self.logger.info(f"Starting SellMyBooks crawler. Limit: {self.limit_pages} pages.")
...
if __name__ == "__main__":
    spider = SellMyBooksSpider(limit_pages=3)
    spider.run()
