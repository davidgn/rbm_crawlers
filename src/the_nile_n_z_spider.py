...
class TheNileNZSpider(HTMLSearchSpider):
    """Broad crawler for The Nile (NZ) (New Zealand)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="The Nile (NZ)",
            territory="New Zealand",
            base_url="www.thenile.co.nz",
            search_path="search?s={search_term}",
            currency="NZD",
