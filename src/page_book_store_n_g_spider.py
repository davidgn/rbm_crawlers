...
class PageBookStoreNGSpider(HTMLSearchSpider):
    """Broad crawler for PAGE Book Connoisseurs (NG) (Nigeria)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="PAGE Book Connoisseurs (NG)",
            territory="Nigeria",
            base_url="pagebookstore.com",
