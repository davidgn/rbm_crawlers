...
class MentesOcultasCOSpider(NodriverSearchSpider):
    """Broad crawler for Mentes Ocultas (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Mentes Ocultas (CO)",
            territory="Colombia",
            base_url="https://mentesocultasybardas.com",
