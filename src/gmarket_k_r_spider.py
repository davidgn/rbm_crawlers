...
class GmarketKRSpider(NodriverSearchSpider):
    """Broad crawler for Gmarket (KR) (South Korea)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Gmarket (KR)",
            territory="South Korea",
            base_url="www.gmarket.co.kr",
            search_path="n/search?keyword={search_term}",
            currency="KRW",
