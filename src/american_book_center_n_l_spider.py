...
class AmericanBookCenterNLSpider(HTMLSearchSpider):
    """Broad crawler for American Book Center (NL) (Netherlands)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="American Book Center (NL)",
