...
class AlianzaLibreriaCOSpider(HTMLSearchSpider):
    """Broad crawler for Alianza Librería (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Alianza Librería (CO)",
            territory="Colombia",
            base_url="https://www.alianzalibros.com",
            search_path="tienda/busqueda?q={search_term}",
            currency="COP",
