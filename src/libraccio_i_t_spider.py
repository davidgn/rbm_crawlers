...
class LibraccioITSpider(HTMLSearchSpider):
    """Broad crawler for Libraccio (IT) (Italy)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Libraccio (IT)",
            territory="Italy",
            base_url="www.libraccio.it",
            search_path="ricerca?q={search_term}",
            currency="EUR",
