...
class JudobiBookShelfNGSpider(HTMLSearchSpider):
    """Broad crawler for JUDOBI BookShelf (NG) (Nigeria)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="JUDOBI BookShelf (NG)",
            territory="Nigeria",
            base_url="judobibookshelf.com",
