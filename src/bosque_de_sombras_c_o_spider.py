...
class BosqueDeSombrasCOSpider(HTMLSearchSpider):
    """Broad crawler for Bosque de Sombras (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Bosque de Sombras (CO)",
            territory="Colombia",
            base_url="https://www.bosquedesombras.com",
