...
class BibliostockESSpider(HTMLSearchSpider):
    """Broad crawler for Bibliostock (ES) (Spain)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Bibliostock (ES)",
            territory="Spain",
            base_url="www.bibliostock.com",
            search_path="buscar?controller=search&s={search_term}",
            currency="EUR",
