...
class EdicionesHispanicasCOSpider(HTMLSearchSpider):
    """Broad crawler for Ediciones Hispánicas (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Ediciones Hispánicas (CO)",
            territory="Colombia",
