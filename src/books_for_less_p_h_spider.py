...
class BooksForLessPHSpider(HTMLSearchSpider):
    """Broad crawler for Books for Less (PH) (Philippines)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Books for Less (PH)",
            territory="Philippines",
            base_url="booksforless.ph",
