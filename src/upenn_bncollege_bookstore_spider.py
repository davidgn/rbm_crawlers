...
class UpennBookstoreSpider(PlaywrightSearchSpider):
    """Playwright-based spider for Upenn Bookstore (BN College platform)."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Upenn Bookstore Playwright Spider")
    parser.add_argument("--query", type=str, default="textbook")
    parser.add_argument("--limit-pages", type=int, default=1)
    parser.add_argument("--limit-items", type=int, default=5)
    args, _ = parser.parse_known_args()
    spider = UpennBookstoreSpider(limit_pages=args.limit_pages, limit_items=args.limit_items)
