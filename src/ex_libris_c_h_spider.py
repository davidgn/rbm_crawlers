...
class ExLibrisCHSpider(HTMLSearchSpider):
    """Broad crawler for Ex Libris (CH) (Egypt)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Ex Libris (CH)",
            territory="Egypt",
            base_url="https://www.exlibris.ch",
            search_path="de/suche/?q={search_term}",
            currency="EGP",
