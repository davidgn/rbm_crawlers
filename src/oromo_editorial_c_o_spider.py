...
class OromoEditorialCOSpider(HTMLSearchSpider):
    """Broad crawler for Oromo Editorial (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Oromo Editorial (CO)",
            territory="Colombia",
            base_url="https://www.oromolibreriaeditorial.com.co",
