...
class PromolibrocoCOSpider(HTMLSearchSpider):
    """Broad crawler for Promolibro (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Promolibro (CO)",
            territory="Colombia",
            base_url="https://www.promolibro.com.co",
