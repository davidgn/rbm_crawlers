...
class HibernianBooksESSpider(HTMLSearchSpider):
    """Broad crawler for Hibernian Books (ES) (Spain)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Hibernian Books (ES)",
            territory="Spain",
            base_url="www.hibernian-books.com",
