...
class LibreriaTemisColCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería Temis (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería Temis (CO)",
            territory="Colombia",
            base_url="https://libreriatemis.com",
