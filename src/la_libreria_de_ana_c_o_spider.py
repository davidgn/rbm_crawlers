...
class LaLibreriaDeAnaCOSpider(HTMLSearchSpider):
    """Broad crawler for Librería de Ana (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Librería de Ana (CO)",
            territory="Colombia",
            base_url="https://www.lalibreriadeana.com",
