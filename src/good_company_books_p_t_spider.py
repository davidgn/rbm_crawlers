...
class GoodCompanyPTSpider(HTMLSearchSpider):
    """Broad crawler for Good Company Books (PT) (Portugal)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Good Company Books (PT)",
            territory="Portugal",
            base_url="goodcompanybooks.com",
