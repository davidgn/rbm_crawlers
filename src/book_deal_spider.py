...
class BookDealSpider(HTMLSearchSpider):
    """Broad crawler for BookDeal (Peru)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="BookDeal",
            territory="Peru",
            base_url="https://www.bookdeal.com",
            search_path="product.php?ISBN={search_term}",
            currency="PEN",
