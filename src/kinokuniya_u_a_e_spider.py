...
class KinokuniyaUAESpider(NodriverSearchSpider):
    """Broad crawler for Kinokuniya (UAE) (UAE)."""
    def __init__(self, search_term: str = "books", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Kinokuniya (UAE)",
            territory="UAE",
            base_url="uae.kinokuniya.com",
            search_path="products?is_searching=true&restrictBy=Title&keywords={search_term}",
            currency="AED",
