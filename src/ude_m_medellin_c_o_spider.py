...
class UdeMMedellinCOSpider(HTMLSearchSpider):
    """Broad crawler for Sello Editorial UdeM (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Sello Editorial UdeM (CO)",
            territory="Colombia",
            base_url="https://selloeditorial.udemedellin.edu.co",
