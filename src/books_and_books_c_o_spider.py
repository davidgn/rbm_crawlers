...
class BooksAndBooksCOSpider(HTMLSearchSpider):
    """Broad crawler for Books & Books (CO) (Colombia)."""
    def __init__(self, search_term: str = "libros", limit_pages: int = 50, limit_items: int | None = None):
        super().__init__(
            platform_name="Books & Books (CO)",
            territory="Colombia",
            base_url="https://www.booksandbooks.com.co",
